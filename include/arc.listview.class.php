...
echo $this->Fields['typename']." [ID:{$this->TypeID}] ".$GLOBALS['cfg_basedir'].$GLOBALS['cfg_templets_dir']."/".$this->TypeLink->TypeInfos['templist']."模板文件不存在，无法解析文档！";
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
      ...
      $maininfo = "<li><span class=\"pageinfo\">Total <strong>{$totalpage}</strong> Page <strong> ".$this->TotalResult."</strong> Records</span></li>\r\n"; 
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>Home Page</a></li>\r\n";
        }
        else
        {
            $indexpage="<li>Home Page</li>\r\n";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".$purl."PageNo=1'>Home Page</a></li>\r\n";
        }
        else
        {
            $indexpage="<li><a>Home Page</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a href='".$purl."PageNo=$nextpagenum'>Next</a></li>\r\n";
            $endpage="<li><a href='".$purl."PageNo=$totalpage'>Last Page</a></li>\r\n";
        }
        else
        {
